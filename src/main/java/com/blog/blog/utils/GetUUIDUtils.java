...
public class GetUUIDUtils {
    ...
    static private char[] alphabet = "01234567890123456789012345678901234567890123456789012345678901234".toCharArray();
...
//		Date d1 = new Date();
        ...
        for (int i = 0; i < 50000; i++) {
            ...
            String g = getUUIDBits(15);
            for (int ii = 0; ii < strList.size(); ii++) {
                if (g.equals(strList.get(ii))) {
                    System.out.println(g);
                    break;
                }
            }
            strList.add(g);
            //System.out.println(getUUIDBits(15));
        }
//		Date d2 = new Date();
